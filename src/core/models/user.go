...
type User struct {
	...
	ProfilePicURL         string    `gorm:"column:profile_pic_url;type:text;not null" json:"profile_pic_url"`
	ProfilePicSize        int       `gorm:"column:profile_pic_size;type:int;not null;default:0" json:"profile_pic_size"`
	ProfilePicStoragePath string    `gorm:"column:profile_pic_storage_path;type:text;not null" json:"profile_pic_storage_path"`
